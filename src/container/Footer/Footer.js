  ...
  <div className="app__footer section__padding pb-0">
    ...
    <div className="app__footer-links flex-column flex-md-row mt-5 px-3">
      <div className="app__footer-links_contact">
        ...
        <p className="p__opensans">No 57 Jamshoro mall, Havelli, Romania</p>
        <p className="p__opensans">+440974549923</p>
        <p className="p__opensans">+440965790630</p>
      </div>
    ...
    <div className="footer__copyright">
      <p className="p__opensans">2025 Mizuka. All rights reserved</p>
    </div>
  </div>
);
