const branches = [
  {
    Continent: 'Pakistan',
    locations: [
      { city: 'Hyderabad, Sindh, Pakistan', available: true },
      { city: 'Karachi, Sindh, Pakistan', available: true },
      { city: 'Lahore, Punjab, Pakistan', available: true },
      { city: 'Islamabad, Pakistan', available: true },
      { city: 'Peshawar, KPK, Pakistan', available: false },
    ],
  },
